    ...
    def le_pagina(self, acao):
        ...
        try:
            dfPagina = pd.DataFrame({
                ...
                'cod_acao' : acao,
                'vlr_acao' : [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_vlr_acao))],
                'vlm_diario' : [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_vlm_diario))],
                'dy' : [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_dy))],
                'pl' : [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_pl))],
                'pvp' : [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_pvp))],
                'vpa' : [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_vpa))],
                'roe' : [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_roe))],
                'lpa' : [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_lpa))],
                'pebit':  [self.tryCast(self.nv.pegar_valor_elemento_por_xpath( element_pebit))]
            })
